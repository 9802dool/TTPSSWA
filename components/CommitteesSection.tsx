      ...
      {COMMITTEES.map((c) => (
        <li key={c.id}>
          <Link
            ...
            className="block min-h-[4.25rem] rounded-xl border border-white/10 bg-slate-950/80 px-4 py-4 text-sm font-bold text-white shadow-sm transition hover:border-sky-400/35 hover:bg-slate-900/90"
          >
            {c.title}
          </Link>
        </li>
