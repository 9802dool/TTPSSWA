  ...
  return (
    <div className="mb-8 flex flex-col items-center">
      ...
      <div className="mt-3 flex flex-col items-center">
        ...
        >
          <div className="flex aspect-[3/4] w-[min(9rem,32vw)] items-center justify-center border border-dashed border-slate-400 bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-50 dark:to-slate-100">
      ...
      <p className="mt-4 max-w-md text-center text-[11px] leading-relaxed text-slate-600 dark:text-slate-600">
        Section <strong className="font-semibold text-slate-800">IX</strong> below — use{" "}
