  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 shadow-corp">
      ...
      <div className="border-b border-line bg-white/95 backdrop-blur-md dark:bg-white/90">
        <div className="mx-auto flex min-h-[4.25rem] max-w-6xl flex-wrap items-center justify-start gap-x-0.5 gap-y-1 px-4 py-2 sm:gap-x-1 sm:px-6 lg:px-8">
          <nav className="flex flex-wrap items-center gap-x-0.5 gap-y-1 sm:gap-x-1" aria-label="Primary">
            {nav.map((item) => (
