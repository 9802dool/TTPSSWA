        ...
        <section className="relative overflow-hidden border-b border-line bg-navy pt-[var(--site-header-stack)] text-white">
          ...
          <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-16 sm:px-6 sm:pb-28 sm:pt-20 lg:px-8">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-4">
              <Link
                href="/login"
                className="site-btn-primary-fluid site-btn-hero-ring"
              >
                Become a Member Apply Here
              </Link>
              <Link href="/members-portal" className="site-btn-secondary-fluid">
                Access members portal
              </Link>
              <Link href="/membership-services" className="site-btn-secondary-fluid">
                Members services
              </Link>
              <Link href="/hotel-reservations" className="site-btn-secondary-fluid">
                Hotel Reservation
              </Link>
              <a href="/executive" className="site-btn-secondary-fluid">
                Executive Team
              </a>
            </div>
          </div>
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-6">
                <Link href="/partnership" className="site-btn-inline-primary">
