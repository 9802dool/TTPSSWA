    ...
    <>
      ...
      <main className="min-h-[calc(100vh-4.25rem)] bg-[#f4f6f9] pt-[4.25rem] dark:bg-canvas">
        ...
        <div className="mx-auto max-w-3xl px-4 pb-16 pt-8 sm:px-6 lg:px-8">
          <div className="rounded-xl border border-line bg-surface p-6 shadow-corp dark:bg-canvas">
          ...
          <div className="mt-10 rounded-sm border border-line bg-surface shadow-[0_1px_3px_rgba(0,0,0,0.08),0_8px_24px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-line dark:bg-surface dark:shadow-corp dark:ring-white/5">
