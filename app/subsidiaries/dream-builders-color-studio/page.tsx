...
export const metadata: Metadata = {
  title: "Dream Builders Color Studio | TTPSSWA",
  description: "TTPSSWA subsidiary — Dream Builders Color Studio.",
};

export default function DreamBuildersColorStudioPage() {
  return (
    <>
      <SiteHeader />
      <main className="min-h-[calc(100vh-var(--site-header-stack))] bg-slate-950 pt-[var(--site-header-stack)] text-slate-100">
        <section className="relative overflow-hidden border-b border-slate-800 bg-navy text-white">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
            ...
            <h1 className="text-3xl font-bold tracking-tight md:text-4xl">Dream Builders Color Studio</h1>
            <p className="mt-4 max-w-3xl text-lg leading-relaxed text-slate-300">
              Colour and finishing solutions for projects supporting the association’s mission. Updates can be added
              here when available.
            </p>
          </div>
        </section>
